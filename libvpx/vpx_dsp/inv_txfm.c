...
void vpx_highbd_iwht4x4_16_add_c(const tran_low_t *input, tran_high_t* dest,
                                 int stride, int bd) {
  /* 4-point reversible, orthonormal inverse Walsh-Hadamard in 3.5 adds,
     0.5 shifts per pixel. */
  int i;
...
void vpx_highbd_idct4x4_16_add_c(const tran_low_t *input, tran_high_t* dest,
                                 int stride, int bd) {
  int i, j;
  tran_low_t out[4 * 4];
  tran_low_t *outptr = out;
...
void vpx_highbd_idct8x8_64_add_c(const tran_low_t *input, tran_high_t* dest,
                                 int stride, int bd) {
  int i, j;
  tran_low_t out[8 * 8];
  tran_low_t *outptr = out;
...
void vpx_highbd_idct16x16_256_add_c(const tran_low_t *input, tran_high_t* dest,
                                    int stride, int bd) {
  int i, j;
  tran_low_t out[16 * 16];
  tran_low_t *outptr = out;
...
void vpx_highbd_idct32x32_1024_add_c(const tran_low_t *input, tran_high_t* dest,
                                     int stride, int bd) {
  int i, j;
  tran_low_t out[32 * 32];
  tran_low_t *outptr = out;
